    ...
    <div class="card p-3 px-4 mb-3 text-center text-md-start">
        <div class="d-md-flex justify-content-between align-items-center">
            <div class="mb-3 mb-md-0">
                <div class="text-3xl fw-semibold">Manage "Sid's Evil Lair"</div>
                <div class="text-muted">
                    Creator: <a href="#" class="fw-semibold">Sid</a>
                </div>
            </div>
            <div class="text-center">
                <div class="text-bold">
                    <span class="text-success text-xl me-2">
                        <i class="bi bi-cash-stack text-2xl me-1 align-middle"></i> 10k+
                    </span>
                    <span class="text-warning text-xl">
                        <i class="bi bi-coin text-2xl me-1 align-middle"></i> 110k+
                    </span>
                </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="nav flex-column nav-pills mb-3 mb-md-0" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <button class="nav-link" id="settings-tab" data-bs-toggle="pill" data-bs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="true">
                    Settings
                </button>
                ...
                <button class="nav-link" id="vault-tab" data-bs-toggle="pill" data-bs-target="#vault" type="button" role="tab" aria-controls="vault" aria-selected="true">
                    Vault
                </button>
                    ...
                    <div class="card card-body mb-3">
                        <div class="row gy-4">
                            <div class="col-lg-5">
                                ...
                                <div class="community-logo-manage bg-secondary rounded-circle p-3 mx-auto">
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="text-3xl fw-semibold mb-3">Sid's Evil Lair</div>
                                <div class="text-xs fw-bold text-muted mb-1">
                                    COMMUNITY DESCRIPTION
                                </div>
                                <textarea rows="8" class="form-control">
we love sid please marry us sid my dearest owo love u man owo uwu</textarea>
                            </div>
                            <div class="text-end">
                    ...
                    <div class="card card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="min-w-0">
                                ...
                                <div class="text-3xl fw-semibold">Sid</div>
                            </div>
                    ...
                    <div class="card card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="privateSwitch" />
                            </div>
                        </div>
                        <hr />
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="text-xl fw-semibold">
                                Show community funds on the community page
                            </div>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="fundsSwitch" checked />
                            </div>
                        </div>
                        <hr />
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="text-xl fw-semibold">
                                Show community games on the community page
                            </div>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="gamesSwitch" checked />
                            </div>
                        </div>
                        <hr />
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="affiliateSwitch" checked />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tab-pane" id="members" role="tabpanel" aria-labelledby="members-tab" tabindex="0">
                    ...
                    <div class="card p-3">
                        <div class="row">
                            <div class="col-md-8">
                                <input type="text" class="form-control mb-2 mb-md-0" placeholder="Search for members..." />
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="section">
                            <div class="row gy-2 align-items-center">
                                <div class="col-md-3">
                                    ...
                                    <div class="text-xl fw-semibold text-light truncate">
                                        sid lover
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-6 text-end">
                                    <a href="#" class="btn btn-primary d-block d-md-inline-block text-center text-md-start">Edit Role</a>
                                </div>
                            </div>
                        </div>
                        <div class="section">
