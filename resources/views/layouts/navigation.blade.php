...
<div class="navbar navbar-dark sticky-top bg-dark d-none d-md-flex flex-md-nowrap p-0 border-bottom">
    <a class="navbar-brand col-auto me-0 px-3" href="#"><img class="navbar-brand-logo d-none d-md-block" src="{{ asset('img/branding/light_long.svg') }}"></a>
    <div class="col-auto d-md-none"></div>
    <input class="form-control form-control-dark w-100 d-none d-md-block" type="text" placeholder="Search anything on Buildaverse..." aria-label="Search">
            ...
            <div class="nav-item text-nowrap nav-pill">
                ...
                <span class="dropdown">
					...
					<ul class="dropdown-menu notification-dropdown" aria-labelledby="bellDropdown" data-bs-popper="static">
						<li class="text-center"><span class="dropdown-item-text notification-dropdown-title">Notifications<span class="badge rounded-pill bg-primary notif-badge">2</span></span></li>
						<li>
						...
						<li class="notif notif-new">
							<a href="#" class="text-decoration-none notif-link">
								<div class="d-flex pt-3 border-bottom w-100">
									<img class="notif-pfp" src="{{ asset('img/avatar/headshot.png') }}">
                ...
                <span class="dropdown">
					...
					<a class="nav-pill-section position-relative icon-dropdown" href="#" style="position: relative; right: 1px;"
                       role="button" id="tradeDropdown" data-bs-toggle="dropdown" aria-expanded="false">
						<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi-arrow-left-right nav-pill-section-icon" viewBox="0 0 16 16">
					...
					<ul class="dropdown-menu notification-dropdown" aria-labelledby="tradeDropdown" data-bs-popper="static">
						<li class="text-center">
                            <span class="dropdown-item-text notification-dropdown-title">Incoming Trades<span class="d-none badge rounded-pill bg-primary notif-badge">2</span></span>
                        </li>
						<li>
							<hr class="dropdown-divider mb-0">
						</li>
						...
						<li class="notif">
							<a href="#" class="text-decoration-none notif-link">
								<div class="d-flex pt-3 border-bottom w-100">
									<img class="notif-icon notif-icon-success" src="{{ asset('img/icons/trade.png') }}">
									<div class="pb-3 mb-0 small lh-sm w-100 notif-text">
						...
						<li class="text-center">
							<div class="dropdown-item-text notif-info">
								You're all caught up!<br>
								<a href="#">All Trades</a>&nbsp;&nbsp;<a href="#" type="button" data-bs-toggle="modal" data-bs-target="#declineTradesModal">Decline All</a>
							</div>
						</li>
					</ul>
				</span>
                ...
                <span class="dropdown">
					...
					<!-- Friend icon -->
					<a class="nav-pill-section nav-pill-icon-right position-relative icon-dropdown" href="#" role="button" id="friendDropdown" data-bs-toggle="dropdown" aria-expanded="false">
					...
					<ul class="dropdown-menu notification-dropdown" aria-labelledby="friendDropdown" data-bs-popper="static">
                        <li class="text-center">
                            <span class="dropdown-item-text notification-dropdown-title">Friend Requests<span class="d-none badge rounded-pill bg-primary notif-badge">2</span></span>
                        </li>
                        <li>
                            <hr class="dropdown-divider mb-0">
                        </li>
        ...
        <div class="navbar-nav dropdown d-inline-block">
            <div class="nav-item text-nowrap nav-pill" role="button" id="userDropdown" data-bs-toggle="dropdown"
                ...
                <a href="#" class="nav-link nav-user">
                    ...
                    <img class="nav-pfp" src="{{ asset('img/avatar/headshot.png') }}">
                </a>
            </div>
            <ul class="dropdown-menu dropdown-menu-end user-dropdown" aria-labelledby="userDropdown" data-bs-popper="static">
                ...
                <li><a class="dropdown-item" href="#"><i class="bi bi-pencil-square"></i> Edit Character</a></li>
...
<div class="sidebar-container d-none d-md-flex">
    <div class="d-flex flex-column flex-shrink-0 sidebar">
        <ul class="nav nav-pills nav-flush flex-column mb-auto text-center mt-2">
            ...
            @auth
            <li>
                <a href="#" class="nav-link sidebar-icon my-3 py-0" title="Create" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Create">
        ...
        <div>
            <ul class="nav nav-pills nav-flush flex-column mb-auto text-center mt-2">
                ...
                @endauth
                <li class="nav-item">
                    <a href="https://blog.buildaverse.com/" target="_blank" rel="noopener noreferrer" class="nav-link sidebar-icon my-3 py-0" aria-current="page" title="Blog" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Blog">
