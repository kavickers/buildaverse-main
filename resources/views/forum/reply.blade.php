<x-app-layout>
    <x-slot name="title">Replying to "{!! nl2br(e($thread->title)) !!}"</x-slot>
    ...
    <h2>Replying to "{!! nl2br(e($thread->title)) !!}"</h2>
    <div class="card mb-3 mt-3 mt-md-0">
        <div class="card-body pb-4">
            <form method="POST" action="{{ route('forum.thread.reply.post', $thread->id) }}">
                @csrf
