            ...
            <div class="col-3 col-md-3">
                <div class="d-flex align-items-center">
                    <a href="{{ route('user.profile', $thread->owner->id) }}">
                        ...
                        <img src="img/avatar/headshot.png" class="headshot rounded-circle d-block d-md-none" width="60" />
                    </a>
                ...
                <a href="{{ route('forum.thread', $thread->id) }}" class="text-muted">
                    ...
                    <div class="mt-1 truncate d-block d-md-none">
                        ...
                        <span class="text-danger fw-normal">
                                <i class="bi @guest bi-heart @endguest @auth @if(auth()->user()->forumHasLiked($thread->id)) bi-heart-fill @else bi-heart @endif @endauth me-1"></i><span class="text-sm">{{ $thread->owner->get_short_num($thread->likes()->count()) }}</span>
                            </span>
                        <span class="mx-1 text-muted text-xs">&bullet;</span>
