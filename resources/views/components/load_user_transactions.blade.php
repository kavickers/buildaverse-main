    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-3">
            ...
            <div class="d-flex gap-2 align-items-center">
                ...
                <img src="{{ ('/img/branding/light_icon.svg') }}" class="img-fluid p-2" width="60" />
        ...
        <div class="col-md-2 col-6 d-none d-md-block text-center">
            <img src="img/avatar/headshot.png" class="d-block img-fluid rounded-circle headshot mx-auto" width="60" />
        ...
        <div class="col-md-2">
            ...
            <div>
                ...
                <span class="d-block text-success fw-semibold mb-2">
                    <i class="bi-cash-stack text-xl lh-1 align-middle me-1 me-md-2"></i>{{ auth()->user()->get_short_num($transaction->cash) }}
                </span>
                @endif
                @if($transaction->coins > 0)
                <span class="d-block text-warning fw-semibold">
                    <i class="bi-coin text-xl lh-1 align-middle me-1 me-md-2"></i>{{ auth()->user()->get_short_num($transaction->coins) }}
                </span>
                @endif
            </div>
        </div>
