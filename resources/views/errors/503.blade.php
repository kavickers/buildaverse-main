                        ...
                        <div class="col-lg-5 col-md-5">
                            <content>
                                ...
                                <p class="mt-0 font-size-18">
                                    If all goes to plan, we should be back up in no time. Don't fret, we'll load the page automatically once we're done. In the mean time, why not join our <a href="https://discord.gg/buildaverse" target="_blank">Discord server</a>?
                                </p>
                            </content>
                        </div>
                    </div>
